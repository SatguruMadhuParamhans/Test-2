...
struct SatguruText1: View{
    ...
    var body: some View {
        LazyVStack{
            Text("His holiness Sadguru Madhu Paramhansji has served in the Indian army for 24 years. In 1967 at the age of 17, He joined Indian Army in Mahar Regiment and served the nation for 24 years till 1991. He retired as J.C.O (Junior Commissioned Officer) taking voluntary retirement from Indian Army.")
                .frame(height: 165)
        }
            .padding()
            .background()
