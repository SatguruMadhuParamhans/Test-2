...
struct SatguruVsGuruText4: View{
    ...
    var body: some View {
        ...
        Text("**Guru**: Guru does not have the power in his concentration to transform any individual human being and make him/her like himself.     .")
            .padding()
            .background()
            .overlay(RoundedRectangle(cornerRadius: 15)
                .stroke(Color(#colorLiteral(red: 0.9952186942, green: 0.9027745128, blue: 0.8957005143, alpha: 1)), lineWidth: 10))
...
struct SatguruVsGuruText8: View{
    ...
    var body: some View {
        ...
        Text("(Worldly people are engaged in the worship of Gods and Goddesses by performing thousands of rituals whereas, the worship of a true Perfect Spiritual Master (Satguru) itself includes the worship of whole divine wisdom.)")
            .padding()
            .padding(.top, -20)
